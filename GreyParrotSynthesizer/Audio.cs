...
namespace GreyParrotSynthesizer
{
    internal class Audio
    {
        ...
        public static void PlaySound(float frequency = 200f, WaveUtils.WaveType soundWave = WaveUtils.WaveType.SINE, int seed = -1) // WE MIGHT WANT TO ADD AN AMPLITUDE PARAMETER
        {
            ...
            for (int i = 0; i < SAMPLE_RATE; i++)
            {
                ...
                wave[i] = WaveUtils.WaveCalc(frequency, i, soundWave, SAMPLE_RATE, seed);
            }
